...
let APIInfo = {
  ...
  google: {
    ...
    searchParams: {
      key: "AIzaSyD3DcquX1CFW6pB6bmQrTcZ3O_WEWYtK5I", /* "AIzaSyAZ7f_TuBgtdcgXIhd2HouvK2Qu_jMpGX4", */
      cx: '000457940223891916115:2oiuyyxlube', /* '000457940223891916115:vv6akwfhiiy', */
      q: "This value is replaced by handleFormInput()",
      searchType: "image",
      num: "10",
      /* count: "10", */
...
function fetchAPIData(apiName, query) {
  ...
  /* fetch call to test multiple google API calls */
